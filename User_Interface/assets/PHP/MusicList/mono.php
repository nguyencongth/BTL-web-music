...
<body>
            ...
            <div class="playerBar_item">
                <div class="playerBar_item-info">
                    ...
                    <div class="playerBar_item-name">
                        <div class="playerBar_item-name--nameSong">Waiting For You</div>
                        <div class="playerBar_item-name--nameArtist">Mono</div>
                    </div>
                </div>
                <div>
    ...
    <?php
    $conn = mysqli_connect('localhost', 'root', '', 'nhom8_web-music');
    $result = mysqli_query($conn, "SELECT * from music1, singer where singer.ID_Singer = music1.ID_Singer and Name_Singer like 'Mono' ");
    $a=0;
     ?>
    <script>
        ...
        const app = {
            ...
            songs: [
                <?php while($row = mysqli_fetch_assoc($result)){ $a++; echo "{" ?>
                    ...
                    path: '<?php echo "../../Music/Mono/" . $row["SRC_Music"] ?>',
