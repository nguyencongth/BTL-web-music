...
<head>
    ...
    <title>Bích Phương - nhạc Bích Phương</title>
</head>
...
<body>
    ...
    <div id="main">
        ...
        <div id="banner">
            ...
            <div class="banner-img">
                <img src="../../img/bichphuong.jpg" alt="">
            </div>
        </div>
    ...
    <?php
    $conn = mysqli_connect('localhost', 'root', '', 'nhom8_web-music');
    $result = mysqli_query($conn, "SELECT * from music1, singer where singer.ID_Singer = music1.ID_Singer and Name_Singer like 'Bích Phương' ");
    $a=0;
     ?>
    <script>
        ...
        const app = {
            ...
            songs: [
                <?php while($row = mysqli_fetch_assoc($result)){ $a++; echo "{" ?>
                    ...
                    path: '<?php echo "../../Music/BichPhuong/" . $row["SRC_Music"] ?>',
