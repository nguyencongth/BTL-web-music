            ...
            <div class="content w3-container" style="height:1000px;">
                ...
                <div>
                    <form action="" method="POST">
                        <table>
                            <h2><strong>Update Music</strong></h2>
                            <tr>
                                <td>Song Name:</td>
                                <td><input type="text" name="txtSong" id="txtSong" size="22" value="<?php if(isset($Name_Music)){echo $Name_Music;} ?>"></td>
                            </tr>
                            <tr>
                                <td>Singer Name:</td>
                                <td><input type="text" name="txtSinger" id="txtSinger" size="22" value="<?php if(isset($Name_Singer)){echo $Name_Singer;} ?>"></td>
                            </tr>
                            <tr>
                                <td colspan="2" style="text-align: center;">
                                    <input type="submit" name="btnGhiDL" value="Update">
                                </td>
                            </tr>
                        </table>
                    </form>
