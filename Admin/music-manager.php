    ...
    <div>
        ...
        <div style="margin-left: 15%;">
            ...
            <div class="content w3-container" style="height:1000px;">
                ...
                <div>
                    <h2><strong>List of songs</strong></h2>
                    <table class="tk">
                        <form action="" method="get">
                            <tr>
                                ...
                                <td><input type="submit" class="btnALL" name="btnALL" value="All" onclick="window.location.href='music-manager.php'"></td>
                            </tr>
                        </form>
                    </table>
                    <button class="btn-add"><a class="add" href="./add-music.php">Add</a></button>
                    <?php
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo '<tr>';
                            echo '<td>' . $row["Name_Music"] . '</td>';
                            echo '<td>' . $row["Name_Singer"] . '</td>';
                            echo '<td>' . "<a class='delete' href = 'delete-music.php?ID_Music=" . $row["ID_Music"] . "' Onclick = 'return confirm(\"Do you want to delete?\");' >Delete</a>" . '</td>';
                            echo '<td>' . "<a class='update' href = 'update-music.php?ID_Music=" . $row["ID_Music"] . "' Onclick = 'return confirm(\"Do you want to update?\");' >Update</a>" . '</td>';
                            echo '</tr>';
                        }
                        echo '</tbody> </table>';
                    }
