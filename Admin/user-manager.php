...
<body>
    ...
    <div>
        ...
        <div class="sidebar w3-sidebar w3-light-grey w3-bar-block" style="width:15%; top: 0">
            ...
            <a href="./user-manager.php" class="active w3-bar-item w3-button">
        ...
        <div style="margin-left: 15%;">
            ...
            <div class="content w3-container" style="height:1000px;">
                ...
                <div>
                    <h2><strong>List of user account</strong></h2>
                    <?php
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        echo '<table cellspacing = "0" cellpadding = "16"> <thead>';
                        echo '<th> Username </th>';
                        echo '<th> Email </th>';
                        echo '<th> Password </th>';
                        echo '<th> Option </th>';
                        echo '</thead> <tbody class="body">';
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo '<tr>';
                            echo '<td>' . $row["USER"] . '</td>';
                            echo '<td>' . $row["EMAIL"] . '</td>';
                            echo '<td>' . $row["PASS"] . '</td>';
                            echo '<td>' . "<a class='delete' href = 'delete-user.php?ID_THONGTIN=" . $row["ID_THONGTIN"] . "' Onclick = 'return confirm(\"Bạn có muốn xóa không?\");' >Delete</a>" . '</td>';
                            echo '</tr>';
                        }
                        echo '</tbody> </table>';
                    }
